...
export default function MPProfile() {
  ...
  const handleShare = useCallback((platform: 'whatsapp' | 'x' | 'facebook' | 'instagram') => {
    const url = window.location.href;
    const text = `Check out this MP's profile on MP Dashboard`;
    if (platform === 'whatsapp') {
      ...
      navigator.clipboard.writeText(url).then(() => {
        toast({ title: "Link copied!", description: "Paste it in your Instagram post or story." });
      });
    }
  }, [toast]);
  ...
  // Use absentSessionsData for accurate attendance calculation (matches audit)
  // This data comes from actual Hansard records and is more accurate than static mp fields
  const totalSessions = absentSessionsData?.totalSessions ?? mp.totalParliamentDays ?? 0;
  const sessionsAttended = absentSessionsData 
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              {/* Send Message Button + Share Buttons */}
              <div className="flex items-center gap-3 flex-wrap">
                <ContactMPDialog
                  mpId={mp.id}
                  mpName={mp.name}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#1877F2] hover:bg-[#0d6de0] transition-colors"
                  >
                    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] via-[#dc2743] via-[#cc2366] to-[#bc1888] hover:opacity-90 transition-opacity"
                  >
                    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
              ...
              <div className="grid gap-4">
                ...
                {mp.facebookUrl && (
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-[#1877F2] shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                    <div>
                      <p className="font-medium text-sm text-muted-foreground uppercase tracking-wide mb-1">
                      ...
                      <a href={mp.facebookUrl} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-primary hover:underline break-all">
                        {mp.facebookUrl.replace(/^https?:\/\/(www\.)?facebook\.com\//i, '').replace(/\/$/, '') || mp.facebookUrl}
                      </a>
                    </div>
                  </div>
                )}
                ...
                {mp.instagramUrl && (
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-[#E4405F] shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                    </svg>
                    <div>
                      <p className="font-medium text-sm text-muted-foreground uppercase tracking-wide mb-1">
                      ...
                      <a href={mp.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-primary hover:underline break-all">
                        @{mp.instagramUrl.replace(/^https?:\/\/(www\.)?instagram\.com\//i, '').replace(/\/$/, '') || mp.instagramUrl}
                      </a>
                    </div>
                  </div>
                )}
                ...
                {mp.twitterUrl && (
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-foreground shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                      ...
                      <a href={mp.twitterUrl} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-primary hover:underline break-all">
                        @{mp.twitterUrl.replace(/^https?:\/\/(www\.)?(twitter|x)\.com\//i, '').replace(/\/$/, '') || mp.twitterUrl}
                      </a>
                    </div>
                  </div>
                )}
                ...
                {mp.tiktokUrl && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={mp.tiktokUrl} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-primary hover:underline break-all">
                        @{mp.tiktokUrl.replace(/^https?:\/\/(www\.)?tiktok\.com\/@?/i, '').replace(/\/$/, '') || mp.tiktokUrl}
                      </a>
                    </div>
                  </div>
                )}
          ...
          {(mp.email || mp.telephone || mp.fax || mp.mobileNumber || mp.facebookUrl || mp.instagramUrl || mp.twitterUrl || mp.tiktokUrl || mp.socialMedia || mp.contactAddress || mp.serviceAddress) && (
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                {mp.mobileNumber && (mp.facebookUrl || mp.instagramUrl || mp.twitterUrl || mp.tiktokUrl || mp.socialMedia || mp.contactAddress || mp.serviceAddress) && <Separator />}

                {/* Individual Social Media in Contact Card */}
                {mp.facebookUrl && (
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-[#1877F2] shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">{t('profile.facebook')}</p>
                      <a
                        href={mp.facebookUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-semibold text-primary hover:underline"
                        data-testid="link-mp-facebook"
                      >
                        {mp.facebookUrl.replace(/^https?:\/\/(www\.)?facebook\.com\//i, '').replace(/\/$/, '') || mp.facebookUrl}
                      </a>
                    </div>
                ...
                {mp.facebookUrl && (mp.instagramUrl || mp.twitterUrl || mp.tiktokUrl || mp.socialMedia || mp.contactAddress || mp.serviceAddress) && <Separator />}
                ...
                {mp.instagramUrl && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">{t('profile.instagram')}</p>
                      <a
                        href={mp.instagramUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-semibold text-primary hover:underline"
                        data-testid="link-mp-instagram"
                      >
                        @{mp.instagramUrl.replace(/^https?:\/\/(www\.)?instagram\.com\//i, '').replace(/\/$/, '') || mp.instagramUrl}
                      </a>
                    </div>
                ...
                {mp.instagramUrl && (mp.twitterUrl || mp.tiktokUrl || mp.socialMedia || mp.contactAddress || mp.serviceAddress) && <Separator />}
                ...
                {mp.twitterUrl && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">{t('profile.twitter')}</p>
                      <a
                        href={mp.twitterUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-semibold text-primary hover:underline"
                        data-testid="link-mp-twitter"
                      >
                        @{mp.twitterUrl.replace(/^https?:\/\/(www\.)?(twitter|x)\.com\//i, '').replace(/\/$/, '') || mp.twitterUrl}
                      </a>
                    </div>
                ...
                {mp.twitterUrl && (mp.tiktokUrl || mp.socialMedia || mp.contactAddress || mp.serviceAddress) && <Separator />}
                ...
                {mp.tiktokUrl && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">{t('profile.tiktok')}</p>
                      <a
                        href={mp.tiktokUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-semibold text-primary hover:underline"
                        data-testid="link-mp-tiktok"
                      >
                        @{mp.tiktokUrl.replace(/^https?:\/\/(www\.)?tiktok\.com\/@?/i, '').replace(/\/$/, '') || mp.tiktokUrl}
                      </a>
                    </div>
                ...
                {mp.tiktokUrl && (mp.socialMedia || mp.contactAddress || mp.serviceAddress) && <Separator />}
