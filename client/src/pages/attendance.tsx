...
import { Calendar, ChevronDown, ChevronUp, UserX, Users, TrendingDown } from "lucide-react";
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{report.summary.averageAbsent}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{report.summary.averageAttendanceRate}%</div>
              </CardContent>
            </Card>
