...
export const translations = {
  en: {
    ...
    parliamentVideos: {
      ...
      videoAriaLabel: "Official Dewan Rakyat sessions playlist from Parliament of Malaysia",
      playlistEmbedTitle: "Dewan Rakyat Sessions - Official Parliament of Malaysia Playlist",
      playlistCaption: "Official Dewan Rakyat sessions playlist — use the playlist menu (≡) to browse all 929+ session recordings",
  ...
  ms: {
    ...
    parliamentVideos: {
      ...
      videoAriaLabel: "Senarai main rasmi sesi Dewan Rakyat daripada Parlimen Malaysia",
      playlistEmbedTitle: "Sesi Dewan Rakyat - Senarai Main Rasmi Parlimen Malaysia",
      playlistCaption: "Senarai main rasmi sesi Dewan Rakyat — gunakan menu senarai main (≡) untuk melihat 929+ rakaman sesi",
