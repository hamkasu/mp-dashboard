...
export interface IStorage {
  ...
  getHansardRecordsByParliament(parliamentTerm: string): Promise<HansardRecord[]>;
...
export class MemStorage implements IStorage {
  ...
  private seedMps() {
    ...
    const mpsData: InsertMp[] = [
      ...
      { name: "Zahari Kechik", photoUrl: null, party: "BEBAS", parliamentCode: "P030", constituency: "Jeli", state: "Kelantan", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
      ...
      { name: "Syed Abu Hussin Hafiz Syed Abdul Fasal", photoUrl: null, party: "BEBAS", parliamentCode: "P059", constituency: "Bukit Gantang", state: "Perak", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
      ...
      { name: "Iskandar Dzulkarnain Abdul Khalid", photoUrl: null, party: "BEBAS", parliamentCode: "P067", constituency: "Kuala Kangsar", state: "Perak", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
      ...
      { name: "Zulkafperi Hanapi", photoUrl: null, party: "BEBAS", parliamentCode: "P095", constituency: "Tanjong Karang", state: "Selangor", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
      ...
      // LABUAN (P166)
      { name: "Suhaili Abdul Rahman", photoUrl: null, party: "BEBAS", parliamentCode: "P166", constituency: "Labuan", state: "Labuan", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
  ...
  async getHansardRecordsByParliament(parliamentTerm: string): Promise<HansardRecord[]> {
    return Array.from(this.hansardRecords.values()).filter(
      record => record.parliamentTerm === parliamentTerm
    );
  }
  ...
  async createHansardRecord(insertRecord: InsertHansardRecord): Promise<HansardRecord> {
    ...
    const record: HansardRecord = {
      ...
      summarizedAt: null,
      createdAt: new Date(),
      sessionSpeakerStats: insertRecord.sessionSpeakerStats ?? null,
...
export class DbStorage implements IStorage {
  ...
  async getHansardRecord(id: string): Promise<HansardRecord | undefined> {
    ...
    return {
      ...
      sessionSpeakerStats: row.session_speaker_stats || null,
    ...
    try {
      ...
      const result = await db.execute(sql`
        SELECT 
          ...
          created_at
        FROM hansard_records
        WHERE parliament_term = ${parliamentTerm}
        ORDER BY session_date DESC
      `);
      return result.rows.map((row: any) => ({
        id: row.id,
      ...
      console.error("Error in getHansardRecordsByParliament:", error);
      return [];
    }
  }
