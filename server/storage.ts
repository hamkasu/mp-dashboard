...
export class MemStorage implements IStorage {
  ...
  private seedMps() {
    ...
    const mpsData: InsertMp[] = [
      ...
      { name: "Rafizi Ramli", photoUrl: null, party: "PH", parliamentCode: "P100", constituency: "Pandan", state: "Selangor", gender: "Male", title: "YB", role: "Member of Parliament", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0 },
      ...
      { name: "Bung Moktar Radin", photoUrl: null, party: "BN", parliamentCode: "P187", constituency: "Kinabatangan", state: "Sabah", gender: "Male", title: "YB", role: "Former Member of Parliament (Deceased)", swornInDate, mpAllowance: BASE_MP_ALLOWANCE, ministerSalary: 0, termEndDate: new Date("2025-12-05") },
