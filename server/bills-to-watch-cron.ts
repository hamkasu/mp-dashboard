...
Langkah seterusnya: Dijangka dibentangkan dalam sesi ke-2 (22 Jun–16 Jul) atau ke-3 (5 Okt–8 Dis) 2026.`,
  ...
  },
  {
    ...
    status: "pending",
    icon: "building",
    tags: ["Property", "Development", "Land Rights"],
    ...
    detailsEn: "The Urban Renewal Bill 2025 addresses urban development and property rights in Malaysia. Key concerns include:\n• Balance between development rights and landowner protections\n• Transparent land acquisition and compensation processes\n• Community engagement in renewal projects\n• Protection of heritage sites and cultural landmarks\n\nStatus: Currently pending in parliamentary pipeline.",
    detailsMs: "RUU Pembaharuan Bandar 2025 menangani pembangunan bandar dan hak harta milik di Malaysia. Kebimbangan utama termasuk:\n• Keseimbangan antara hak pembangunan dan perlindungan pemilik tanah\n• Proses pemerolehan tanah dan pampasan yang telus\n• Penglibatan masyarakat dalam projek pembaharuan\n• Perlindungan tapak warisan dan mercu tanda budaya\n\nStatus: Pada masa ini menunggu dalam saluran parlimen.",
    sortOrder: 5,
  },
  {
    ...
    status: "pending",
    icon: "book",
    tags: ["Religious", "3R Sensitive", "Governance"],
    ...
    detailsEn: "The Mufti (Federal Territories) Bill 2024 seeks to clarify and define the roles and authority of religious officials, particularly the Mufti, in Kuala Lumpur, Labuan, and Putrajaya. This bill is highly sensitive due to:\n• Implications on religious freedom and governance (3R: Race, Religion, Royalty)\n• Separation of religious and civil authorities\n• Community consultations on religious matters\n• Potential impact on minority religious rights\n\nStatus: Pending parliamentary tabling.",
    detailsMs: "RUU Mufti (Wilayah Persekutuan) 2024 bertujuan untuk menjelaskan dan mentakrifkan peranan dan kuasa pegawai agama, terutamanya Mufti, di Kuala Lumpur, Labuan, dan Putrajaya. Rang undang-undang ini sangat sensitif kerana:\n• Implikasi ke atas kebebasan agama dan tadbir urus (3R: Kaum, Agama, Raja)\n• Pemisahan antara pihak berkuasa agama dan sivil\n• Perundingan masyarakat mengenai perkara agama\n• Kemungkinan kesan pada hak agama minoriti\n\nStatus: Menunggu pembentangan parlimen.",
    sortOrder: 6,
  },
];
